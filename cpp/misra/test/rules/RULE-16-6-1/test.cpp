...
public:
    ...
    friend TestClass operator+(const TestClass& lhs, const TestClass& rhs) { // COMPLIANT
        return TestClass(lhs.value + rhs.value);
    }
    
    friend bool operator==(const TestClass& lhs, const TestClass& rhs) {     // COMPLIANT
    ...
    friend std::ostream& operator<<(std::ostream& os, const TestClass& tc); // COMPLIANT
