...
from CandidateDeclaration d, Scope candidateScope, Scope currentScope
where
  not isExcluded(d, ScopePackage::unnecessaryExposedIdentifierDeclarationQuery()) and
  ...
  not candidateScope.isAffectedByMacro()
select d,
  ...
  currentScope, "scope", candidateScope, "scope"
