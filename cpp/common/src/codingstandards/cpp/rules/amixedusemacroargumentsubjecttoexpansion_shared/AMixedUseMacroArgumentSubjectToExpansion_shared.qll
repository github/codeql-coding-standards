...
abstract class AMixedUseMacroArgumentSubjectToExpansion_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof AMixedUseMacroArgumentSubjectToExpansion_sharedSharedQuery }
