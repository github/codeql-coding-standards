...
abstract class NonTerminatedEscapeSequences_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof NonTerminatedEscapeSequences_sharedSharedQuery }
