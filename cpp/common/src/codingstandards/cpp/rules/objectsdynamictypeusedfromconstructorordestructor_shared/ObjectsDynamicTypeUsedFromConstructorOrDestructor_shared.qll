...
abstract class ObjectsDynamicTypeUsedFromConstructorOrDestructor_sharedSharedQuery extends Query { }

Query getQuery() {
  result instanceof ObjectsDynamicTypeUsedFromConstructorOrDestructor_sharedSharedQuery
}
