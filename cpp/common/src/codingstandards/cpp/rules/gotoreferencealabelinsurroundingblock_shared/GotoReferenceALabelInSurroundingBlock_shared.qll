...
abstract class GotoReferenceALabelInSurroundingBlock_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof GotoReferenceALabelInSurroundingBlock_sharedSharedQuery }
