...
abstract class ArrayPassedAsFunctionArgumentDecayToAPointer_sharedSharedQuery extends Query { }

Query getQuery() {
  result instanceof ArrayPassedAsFunctionArgumentDecayToAPointer_sharedSharedQuery
}
