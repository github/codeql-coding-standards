...
abstract class HiddenInheritedOverridableMemberFunction_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof HiddenInheritedOverridableMemberFunction_sharedSharedQuery }
