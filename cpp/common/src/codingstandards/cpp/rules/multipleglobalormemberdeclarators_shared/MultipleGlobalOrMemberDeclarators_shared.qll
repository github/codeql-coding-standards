...
abstract class MultipleGlobalOrMemberDeclarators_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof MultipleGlobalOrMemberDeclarators_sharedSharedQuery }
