...
abstract class InitializeAllVirtualBaseClasses_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof InitializeAllVirtualBaseClasses_sharedSharedQuery }
