...
abstract class HiddenInheritedNonOverridableMemberFunction_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof HiddenInheritedNonOverridableMemberFunction_sharedSharedQuery }
