...
abstract class CastCharBeforeConvertingToLargerSizes_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof CastCharBeforeConvertingToLargerSizes_sharedSharedQuery }
