...
abstract class MemoryOperationsNotSequencedAppropriatelySharedQuery extends Query { }

Query getQuery() { result instanceof MemoryOperationsNotSequencedAppropriatelySharedQuery }
