...
abstract class OverridingShallSpecifyDifferentDefaultArguments_sharedSharedQuery extends Query { }

Query getQuery() {
  result instanceof OverridingShallSpecifyDifferentDefaultArguments_sharedSharedQuery
}
