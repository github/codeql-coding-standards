...
abstract class DefinitionNotConsideredForUnqualifiedLookup_sharedSharedQuery extends Query { }

Query getQuery() { result instanceof DefinitionNotConsideredForUnqualifiedLookup_sharedSharedQuery }
