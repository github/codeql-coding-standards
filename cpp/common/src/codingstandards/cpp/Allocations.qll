 ...
 *
 * This is a copy derived from `Critical.NewDelete` from the `codeql/cpp-queries` in `github/codeql`
 * to avoid taking a dependency on the query pack, and to allow further customization.
 */
