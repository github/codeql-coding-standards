...
module ConditionalsPackage {
  Query nonBooleanIfConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TNonBooleanIfConditionQuery())
  }
  ...
  Query nonBooleanIterationConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TNonBooleanIterationConditionQuery())
  }
  ...
  Query switchLessThanTwoCasesQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TSwitchLessThanTwoCasesQuery())
  }
  ...
  Query switchCompoundConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TSwitchCompoundConditionQuery())
  }
  ...
  Query loopCompoundConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TLoopCompoundConditionQuery())
  }
  ...
  Query ifCompoundConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TIfCompoundConditionQuery())
  }
  ...
  Query ifElseTerminationConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TIfElseTerminationConditionQuery())
  }
  ...
  Query switchDoesNotStartWithCaseQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TSwitchDoesNotStartWithCaseQuery())
  }
  ...
  Query switchStatementNotWellFormedQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TSwitchStatementNotWellFormedQuery())
  }
  ...
  Query nestedCaseInSwitchQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TNestedCaseInSwitchQuery())
  }
  ...
  Query nonEmptySwitchClauseDoesNotTerminateQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TNonEmptySwitchClauseDoesNotTerminateQuery())
  }
  ...
  Query missingDefaultInSwitchQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TMissingDefaultInSwitchQuery())
  }
  ...
  Query switchFinalClauseNotDefaultQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TSwitchFinalClauseNotDefaultQuery())
  }
  ...
  Query booleanInSwitchConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TBooleanInSwitchConditionQuery())
  }
  ...
  Query gotoBlockConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TGotoBlockConditionQuery())
  }
  ...
  Query gotoStatementJumpConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TGotoStatementJumpConditionQuery())
  }
  ...
  Query continueInForLoopConditionQuery() {
    ...
    result =
      ...
      TConditionalsPackageQuery(TContinueInForLoopConditionQuery())
  }
}
