...
module RepresentationPackage {
  Query bitFieldsShallBeUsedOnlyWhenInterfacingToHardwareOrConformingToCommunicationProtocolsQuery() {
    ...
    result =
      ...
      TRepresentationPackageQuery(TBitFieldsShallBeUsedOnlyWhenInterfacingToHardwareOrConformingToCommunicationProtocolsQuery())
  }
  ...
  Query auditPossibleHardwareInterfaceDueToBitFieldUsageInDataTypeDefinitionQuery() {
    ...
    result =
      ...
      TRepresentationPackageQuery(TAuditPossibleHardwareInterfaceDueToBitFieldUsageInDataTypeDefinitionQuery())
  }
  ...
  Query objectAssignedToAnOverlappingObjectQuery() {
    ...
    result =
      ...
      TRepresentationPackageQuery(TObjectAssignedToAnOverlappingObjectQuery())
  }
  ...
  Query underlyingBitRepresentationsOfFloatingPointValuesUsedQuery() {
    ...
    result =
      ...
      TRepresentationPackageQuery(TUnderlyingBitRepresentationsOfFloatingPointValuesUsedQuery())
  }
  ...
  Query namedBitFieldsWithSignedIntegerTypeShallHaveALengthOfMoreThanOneBitQuery() {
    ...
    result =
      ...
      TRepresentationPackageQuery(TNamedBitFieldsWithSignedIntegerTypeShallHaveALengthOfMoreThanOneBitQuery())
  }
  ...
  Query memsetUsedToAccessObjectRepresentationQuery() {
    ...
    result =
      ...
      TRepresentationPackageQuery(TMemsetUsedToAccessObjectRepresentationQuery())
  }
  ...
  Query memcmpUsedToAccessObjectRepresentationQuery() {
    ...
    result =
      ...
      TRepresentationPackageQuery(TMemcmpUsedToAccessObjectRepresentationQuery())
  }
  ...
  Query memcpyUsedToAccessObjectRepresentationQuery() {
    ...
    result =
      ...
      TRepresentationPackageQuery(TMemcpyUsedToAccessObjectRepresentationQuery())
  }
}
