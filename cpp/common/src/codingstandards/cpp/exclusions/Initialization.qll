...
module InitializationPackage {
  Query explicitConstructorBaseClassInitializationQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TExplicitConstructorBaseClassInitializationQuery())
  }
  ...
  Query nonStaticMemberMultipleInitQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TNonStaticMemberMultipleInitQuery())
  }
  ...
  Query missedNSDMIOpportunityQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TMissedNSDMIOpportunityQuery())
  }
  ...
  Query constructorWithFundamentalArgMissingExplicitQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TConstructorWithFundamentalArgMissingExplicitQuery())
  }
  ...
  Query avoidDuplicationInConstructorsQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TAvoidDuplicationInConstructorsQuery())
  }
  ...
  Query useInheritingConstructorsQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TUseInheritingConstructorsQuery())
  }
  ...
  Query moveConstructorUsesCopySemanticsQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TMoveConstructorUsesCopySemanticsQuery())
  }
  ...
  Query randomNumberEnginesDefaultInitializedQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TRandomNumberEnginesDefaultInitializedQuery())
  }
  ...
  Query staticOrThreadLocalObjectsNonConstantInitQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TStaticOrThreadLocalObjectsNonConstantInitQuery())
  }
  ...
  Query initializationListOutOfOrderQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TInitializationListOutOfOrderQuery())
  }
  ...
  Query useBracedVariableInitializationQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TUseBracedVariableInitializationQuery())
  }
  ...
  Query avoidAutoWithBracedInitializationQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TAvoidAutoWithBracedInitializationQuery())
  }
  ...
  Query confusingUseOfInitializerListConstructorsQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TConfusingUseOfInitializerListConstructorsQuery())
  }
  ...
  Query multipleLocalDeclaratorsQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TMultipleLocalDeclaratorsQuery())
  }
  ...
  Query multipleGlobalOrMemberDeclaratorsQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TMultipleGlobalOrMemberDeclaratorsQuery())
  }
  ...
  Query useInitBracesToMatchTypeStructureQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TUseInitBracesToMatchTypeStructureQuery())
  }
  ...
  Query missingExplicitInitializersQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TMissingExplicitInitializersQuery())
  }
  ...
  Query nestedZeroValueInitializationQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TNestedZeroValueInitializationQuery())
  }
  ...
  Query cyclesDuringStaticObjectInitQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TCyclesDuringStaticObjectInitQuery())
  }
  ...
  Query badlySeededRandomNumberGeneratorQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TBadlySeededRandomNumberGeneratorQuery())
  }
  ...
  Query useCanonicalOrderForMemberInitQuery() {
    ...
    result =
      ...
      TInitializationPackageQuery(TUseCanonicalOrderForMemberInitQuery())
  }
}
