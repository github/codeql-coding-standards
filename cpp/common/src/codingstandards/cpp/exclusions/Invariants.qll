...
module InvariantsPackage {
  Query memoryManagementFunctionInvariantsQuery() {
    ...
    result =
      ...
      TInvariantsPackageQuery(TMemoryManagementFunctionInvariantsQuery())
  }
  ...
  Query orderingPredicatesInvariantsQuery() {
    ...
    result =
      ...
      TInvariantsPackageQuery(TOrderingPredicatesInvariantsQuery())
  }
  ...
  Query provideAValidOrderingPredicateQuery() {
    ...
    result =
      ...
      TInvariantsPackageQuery(TProvideAValidOrderingPredicateQuery())
  }
  ...
  Query signalHandlerMustBeAPlainOldFunctionQuery() {
    ...
    result =
      ...
      TInvariantsPackageQuery(TSignalHandlerMustBeAPlainOldFunctionQuery())
  }
  ...
  Query honorTerminationReplacementHandlerRequirementsQuery() {
    ...
    result =
      ...
      TInvariantsPackageQuery(THonorTerminationReplacementHandlerRequirementsQuery())
  }
  ...
  Query honorNewReplacementHandlerRequirementsQuery() {
    ...
    result =
      ...
      TInvariantsPackageQuery(THonorNewReplacementHandlerRequirementsQuery())
  }
}
