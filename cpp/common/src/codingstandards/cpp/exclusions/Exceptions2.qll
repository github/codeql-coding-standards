...
module Exceptions2Package {
  Query onlyThrowStdExceptionDerivedTypesQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TOnlyThrowStdExceptionDerivedTypesQuery())
  }
  ...
  Query constructorErrorLeavesObjectInInvalidStateQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TConstructorErrorLeavesObjectInInvalidStateQuery())
  }
  ...
  Query classTypeExceptionNotCaughtByReferenceQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TClassTypeExceptionNotCaughtByReferenceQuery())
  }
  ...
  Query incompatibleNoexceptSpecificationQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TIncompatibleNoexceptSpecificationQuery())
  }
  ...
  Query inconsistentNoexceptFalseSpecificationQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TInconsistentNoexceptFalseSpecificationQuery())
  }
  ...
  Query inconsistentNoexceptTrueSpecificationQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TInconsistentNoexceptTrueSpecificationQuery())
  }
  ...
  Query incompatibleNoexceptSpecificationForOverridersQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TIncompatibleNoexceptSpecificationForOverridersQuery())
  }
  ...
  Query missingCheckedExceptionsQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TMissingCheckedExceptionsQuery())
  }
  ...
  Query inconsistentCheckedExceptionsQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TInconsistentCheckedExceptionsQuery())
  }
  ...
  Query specialFunctionExitsWithExceptionQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TSpecialFunctionExitsWithExceptionQuery())
  }
  ...
  Query specialFunctionMissingNoExceptSpecificationQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TSpecialFunctionMissingNoExceptSpecificationQuery())
  }
  ...
  Query exceptionRaisedDuringStartupQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TExceptionRaisedDuringStartupQuery())
  }
  ...
  Query exceptionRaisedDuringTerminationQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TExceptionRaisedDuringTerminationQuery())
  }
  ...
  Query destroyedValueReferencedInDestructorCatchBlockQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TDestroyedValueReferencedInDestructorCatchBlockQuery())
  }
  ...
  Query catchBlockShadowingMisraQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TCatchBlockShadowingMisraQuery())
  }
  ...
  Query doNotLetExceptionsEscapeFromDestructorsOrDeallocationFunctionsQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TDoNotLetExceptionsEscapeFromDestructorsOrDeallocationFunctionsQuery())
  }
  ...
  Query catchBlockShadowingCertQuery() {
    ...
    result =
      ...
      TExceptions2PackageQuery(TCatchBlockShadowingCertQuery())
  }
}
