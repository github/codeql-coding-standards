...
module NamingPackage {
  Query userDefinedLiteralOperatorSuffixViolationQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TUserDefinedLiteralOperatorSuffixViolationQuery())
  }
  ...
  Query identifierHidingQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TIdentifierHidingQuery())
  }
  ...
  Query identifierNameOfStaticNonMemberObjectReusedInNamespaceQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TIdentifierNameOfStaticNonMemberObjectReusedInNamespaceQuery())
  }
  ...
  Query identifierNameOfStaticFunctionReusedInNamespaceQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TIdentifierNameOfStaticFunctionReusedInNamespaceQuery())
  }
  ...
  Query identifierNameOfAStaticFunctionIsReusedQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TIdentifierNameOfAStaticFunctionIsReusedQuery())
  }
  ...
  Query identifierNameOfANonMemberObjectWithExternalOrInternalLinkageIsReusedQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TIdentifierNameOfANonMemberObjectWithExternalOrInternalLinkageIsReusedQuery())
  }
  ...
  Query classOrEnumerationNameHiddenByAVariableInTheSameScopeQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TClassOrEnumerationNameHiddenByAVariableInTheSameScopeQuery())
  }
  ...
  Query classOrEnumerationNameHiddenByAFunctionInTheSameScopeQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TClassOrEnumerationNameHiddenByAFunctionInTheSameScopeQuery())
  }
  ...
  Query classOrEnumerationNameHiddenByAnEnumeratorInTheSameScopeQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TClassOrEnumerationNameHiddenByAnEnumeratorInTheSameScopeQuery())
  }
  ...
  Query universalCharacterNamesUsedOutsideCharacterOrStringLiteralsQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TUniversalCharacterNamesUsedOutsideCharacterOrStringLiteralsQuery())
  }
  ...
  Query characterOutsideTheLanguageStandardBasicSourceCharacterSetUsedInTheSourceCodeQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TCharacterOutsideTheLanguageStandardBasicSourceCharacterSetUsedInTheSourceCodeQuery())
  }
  ...
  Query invalidCharacterInStringLiteralQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TInvalidCharacterInStringLiteralQuery())
  }
  ...
  Query invalidCharacterInCommentQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TInvalidCharacterInCommentQuery())
  }
  ...
  Query nameOfStandardLibraryMacroOrObjectReusedQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TNameOfStandardLibraryMacroOrObjectReusedQuery())
  }
  ...
  Query nameOfStandardLibraryFunctionIsOverriddenQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TNameOfStandardLibraryFunctionIsOverriddenQuery())
  }
  ...
  Query identifierMainUsedForAFunctionOtherThanTheGlobalFunctionMainQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TIdentifierMainUsedForAFunctionOtherThanTheGlobalFunctionMainQuery())
  }
  ...
  Query unnamedNamespacesInHeaderFileQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TUnnamedNamespacesInHeaderFileQuery())
  }
  ...
  Query nonIdenticalIdentifierUsedForTheParameterInReDeclarationOfAFunctionQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TNonIdenticalIdentifierUsedForTheParameterInReDeclarationOfAFunctionQuery())
  }
  ...
  Query redefiningOfStandardLibraryNameQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TRedefiningOfStandardLibraryNameQuery())
  }
  ...
  Query reuseOfReservedIdentifierQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TReuseOfReservedIdentifierQuery())
  }
  ...
  Query useOfSingleUnderscoreReservedPrefixQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TUseOfSingleUnderscoreReservedPrefixQuery())
  }
  ...
  Query useOfDoubleUnderscoreReservedPrefixQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TUseOfDoubleUnderscoreReservedPrefixQuery())
  }
  ...
  Query useOfReservedLiteralSuffixIdentifierQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TUseOfReservedLiteralSuffixIdentifierQuery())
  }
  ...
  Query objectReusesReservedNameQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TObjectReusesReservedNameQuery())
  }
  ...
  Query functionReusesReservedNameQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TFunctionReusesReservedNameQuery())
  }
  ...
  Query enumeratorReusesReservedNameQuery() {
    ...
    result =
      ...
      TNamingPackageQuery(TEnumeratorReusesReservedNameQuery())
  }
}
