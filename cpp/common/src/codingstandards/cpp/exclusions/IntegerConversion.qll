...
module IntegerConversionPackage {
  Query integerExpressionLeadToDataLossQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TIntegerExpressionLeadToDataLossQuery())
  }
  ...
  Query intMultToLongQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TIntMultToLongQuery())
  }
  ...
  Query implicitChangeOfTheSignednessOfTheUnderlyingTypeQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TImplicitChangeOfTheSignednessOfTheUnderlyingTypeQuery())
  }
  ...
  Query implicitNonConstFloatingIntegralConversionQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TImplicitNonConstFloatingIntegralConversionQuery())
  }
  ...
  Query implicitConstFloatingIntegralConversionQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TImplicitConstFloatingIntegralConversionQuery())
  }
  ...
  Query implicitNonConstConversionToSmallerUnderlyingTypeQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TImplicitNonConstConversionToSmallerUnderlyingTypeQuery())
  }
  ...
  Query implicitConstConversionToSmallerUnderlyingTypeQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TImplicitConstConversionToSmallerUnderlyingTypeQuery())
  }
  ...
  Query explicitFloatingIntegralConversionOfACValueExprQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TExplicitFloatingIntegralConversionOfACValueExprQuery())
  }
  ...
  Query explicitWideningConversionOfACValueExprQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TExplicitWideningConversionOfACValueExprQuery())
  }
  ...
  Query explicitSignednessConversionOfCValueQuery() {
    ...
    result =
      ...
      TIntegerConversionPackageQuery(TExplicitSignednessConversionOfCValueQuery())
  }
}
