...
module ClassesPackage {
  Query nonPodTypeShouldBeDefinedAsClassQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TNonPodTypeShouldBeDefinedAsClassQuery())
  }
  ...
  Query typeDefinedAsStructHasOnlyPublicDataMembersQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TTypeDefinedAsStructHasOnlyPublicDataMembersQuery())
  }
  ...
  Query typeDefinedAsStructHasNoMethodsQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TTypeDefinedAsStructHasNoMethodsQuery())
  }
  ...
  Query typeDefinedAsStructIsNotBaseOfOtherClassOrStructQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TTypeDefinedAsStructIsNotBaseOfOtherClassOrStructQuery())
  }
  ...
  Query typeDefinedAsStructIsDoesNotInheritFromStructOrClassQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TTypeDefinedAsStructIsDoesNotInheritFromStructOrClassQuery())
  }
  ...
  Query missingSpecialMemberFunctionQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TMissingSpecialMemberFunctionQuery())
  }
  ...
  Query classDataMembersInitializationConditionQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TClassDataMembersInitializationConditionQuery())
  }
  ...
  Query redundantMemberFunctionsShouldBeDefaultedOrLeftUndefinedQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TRedundantMemberFunctionsShouldBeDefaultedOrLeftUndefinedQuery())
  }
  ...
  Query nonTemplateMemberDefinedInTemplateQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TNonTemplateMemberDefinedInTemplateQuery())
  }
  ...
  Query trivialOrTemplateFunctionDefinedOutsideClassDefinitionQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TTrivialOrTemplateFunctionDefinedOutsideClassDefinitionQuery())
  }
  ...
  Query nonTrivialNonTemplateFunctionDefinedInsideClassDefinitionQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TNonTrivialNonTemplateFunctionDefinedInsideClassDefinitionQuery())
  }
  ...
  Query inParametersForNotCheapToCopyTypesNotPassedByReferenceQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TInParametersForNotCheapToCopyTypesNotPassedByReferenceQuery())
  }
  ...
  Query inParametersForCheapToCopyTypesNotPassedByValueQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TInParametersForCheapToCopyTypesNotPassedByValueQuery())
  }
  ...
  Query returnsNonConstRawPointersOrReferencesToPrivateOrProtectedDataQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TReturnsNonConstRawPointersOrReferencesToPrivateOrProtectedDataQuery())
  }
  ...
  Query dataTypesUsedForInterfacingWithHardwareOrProtocolsMustBeTrivialAndStandardLayoutQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TDataTypesUsedForInterfacingWithHardwareOrProtocolsMustBeTrivialAndStandardLayoutQuery())
  }
  ...
  Query dataTypesUsedForInterfacingWithHardwareOrProtocolsMustContainOnlyDefinedDataTypeSizesQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TDataTypesUsedForInterfacingWithHardwareOrProtocolsMustContainOnlyDefinedDataTypeSizesQuery())
  }
  ...
  Query memberDataInNonPodClassTypesNotPrivateQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TMemberDataInNonPodClassTypesNotPrivateQuery())
  }
  ...
  Query offsetUsedOnInvalidTypeOrMemberQuery() {
    ...
    result =
      ...
      TClassesPackageQuery(TOffsetUsedOnInvalidTypeOrMemberQuery())
  }
}
