...
module InheritancePackage {
  Query publicInheritanceNotUsedForIsARelationshipQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TPublicInheritanceNotUsedForIsARelationshipQuery())
  }
  ...
  Query nonPublicInheritanceNotUsedForHasARelationshipQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TNonPublicInheritanceNotUsedForHasARelationshipQuery())
  }
  ...
  Query classDerivedFromMoreThanOneNonInterfaceBaseClassQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TClassDerivedFromMoreThanOneNonInterfaceBaseClassQuery())
  }
  ...
  Query hierarchiesShouldBeBasedOnInterfaceClassesQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(THierarchiesShouldBeBasedOnInterfaceClassesQuery())
  }
  ...
  Query classesShouldNotBeDerivedFromVirtualBasesQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TClassesShouldNotBeDerivedFromVirtualBasesQuery())
  }
  ...
  Query baseClassCanBeVirtualOnlyInDiamondHierarchyQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TBaseClassCanBeVirtualOnlyInDiamondHierarchyQuery())
  }
  ...
  Query accessibleBaseClassBothVirtualAndNonVirtualInHierarchyQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TAccessibleBaseClassBothVirtualAndNonVirtualInHierarchyQuery())
  }
  ...
  Query uniqueAccessibleEntityNamesInMultipleInheritanceQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TUniqueAccessibleEntityNamesInMultipleInheritanceQuery())
  }
  ...
  Query dynamicTypeOfThisUsedFromConstructorOrDestructorQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TDynamicTypeOfThisUsedFromConstructorOrDestructorQuery())
  }
  ...
  Query downcastingShouldNotBePerformedOnPolymorphicTypesQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TDowncastingShouldNotBePerformedOnPolymorphicTypesQuery())
  }
  ...
  Query doNotInvokeVirtualFunctionsFromConstructorsOrDestructorsQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TDoNotInvokeVirtualFunctionsFromConstructorsOrDestructorsQuery())
  }
  ...
  Query doNotSliceDerivedObjectsQuery() {
    ...
    result =
      ...
      TInheritancePackageQuery(TDoNotSliceDerivedObjectsQuery())
  }
