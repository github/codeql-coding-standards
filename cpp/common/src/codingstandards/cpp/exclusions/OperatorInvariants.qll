...
module OperatorInvariantsPackage {
  ...
  Query copyAssignmentAndAMoveHandleSelfAssignmentQuery() {
    ...
    result =
      ...
      TOperatorInvariantsPackageQuery(TCopyAssignmentAndAMoveHandleSelfAssignmentQuery())
  }
  ...
  Query assignmentOperatorReturnThisQuery() {
    ...
    result =
      ...
      TOperatorInvariantsPackageQuery(TAssignmentOperatorReturnThisQuery())
  }
  ...
  Query binaryOperatorAndBitwiseOperatorReturnAPrvalueQuery() {
    ...
    result =
      ...
      TOperatorInvariantsPackageQuery(TBinaryOperatorAndBitwiseOperatorReturnAPrvalueQuery())
  }
  ...
  Query oppositeOperatorsNotDefinedInTermsOfOtherQuery() {
    ...
    result =
      ...
      TOperatorInvariantsPackageQuery(TOppositeOperatorsNotDefinedInTermsOfOtherQuery())
  }
  ...
  Query hashSpecializationsHaveANoexceptFunctionCallOperatorQuery() {
    ...
    result =
      ...
      TOperatorInvariantsPackageQuery(THashSpecializationsHaveANoexceptFunctionCallOperatorQuery())
  }
  ...
  Query semanticEquivalenceBetweenOperatorFormNotPreservedQuery() {
    ...
    result =
      ...
      TOperatorInvariantsPackageQuery(TSemanticEquivalenceBetweenOperatorFormNotPreservedQuery())
  }
  ...
  Query gracefullyHandleSelfCopyAssignmentQuery() {
    ...
    result =
      ...
      TOperatorInvariantsPackageQuery(TGracefullyHandleSelfCopyAssignmentQuery())
  }
  ...
  Query copyOperationsMustNotMutateTheSourceObjectQuery() {
    ...
    result =
      ...
      TOperatorInvariantsPackageQuery(TCopyOperationsMustNotMutateTheSourceObjectQuery())
  }
}
