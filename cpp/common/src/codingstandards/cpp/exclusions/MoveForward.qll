...
module MoveForwardPackage {
  Query movedFromObjectReadAccessedQuery() {
    ...
    result =
      ...
      TMoveForwardPackageQuery(TMovedFromObjectReadAccessedQuery())
  }
  ...
  Query forwardingValuesToOtherFunctionsQuery() {
    ...
    result =
      ...
      TMoveForwardPackageQuery(TForwardingValuesToOtherFunctionsQuery())
  }
  ...
  Query moveUsedOnConstObjectsQuery() {
    ...
    result =
      ...
      TMoveForwardPackageQuery(TMoveUsedOnConstObjectsQuery())
  }
  ...
  Query argumentToForwardSubsequentlyUsedQuery() {
    ...
    result =
      ...
      TMoveForwardPackageQuery(TArgumentToForwardSubsequentlyUsedQuery())
  }
  ...
  Query moveFromConsumeParametersRvalRefQuery() {
    ...
    result =
      ...
      TMoveForwardPackageQuery(TMoveFromConsumeParametersRvalRefQuery())
  }
  ...
  Query forwardForwardingReferencesQuery() {
    ...
    result =
      ...
      TMoveForwardPackageQuery(TForwardForwardingReferencesQuery())
  }
  ...
  Query doNotRelyOnTheValueOfAMovedFromObjectQuery() {
    ...
    result =
      ...
      TMoveForwardPackageQuery(TDoNotRelyOnTheValueOfAMovedFromObjectQuery())
  }
}
