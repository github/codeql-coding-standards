...
module ExpressionsPackage {
  Query operationsAssumingMemoryLayoutPerformedOnObjectsQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TOperationsAssumingMemoryLayoutPerformedOnObjectsQuery())
  }
  ...
  Query enumUsedInArithmeticContextsQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TEnumUsedInArithmeticContextsQuery())
  }
  ...
  Query divisorEqualToZeroQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TDivisorEqualToZeroQuery())
  }
  ...
  Query functionErroneousReturnValueNotTestedQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TFunctionErroneousReturnValueNotTestedQuery())
  }
  ...
  Query boolOperandsToDisallowedBuiltInOperatorsQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TBoolOperandsToDisallowedBuiltInOperatorsQuery())
  }
  ...
  Query charUsedAsOperandsToDisallowedBuiltInOperatorsQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TCharUsedAsOperandsToDisallowedBuiltInOperatorsQuery())
  }
  ...
  Query ternaryOperatorConditionNotTypeBoolQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TTernaryOperatorConditionNotTypeBoolQuery())
  }
  ...
  Query bitwiseOperatorOperandsHaveDifferentUnderlyingTypeQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TBitwiseOperatorOperandsHaveDifferentUnderlyingTypeQuery())
  }
  ...
  Query bitwiseOperatorAppliedToSignedTypesQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TBitwiseOperatorAppliedToSignedTypesQuery())
  }
  ...
  Query cvalueExpressionConvertedToDifferentUnderlyingTypeQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TCvalueExpressionConvertedToDifferentUnderlyingTypeQuery())
  }
  ...
  Query constantUnsignedIntegerExpressionsWrapAroundQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TConstantUnsignedIntegerExpressionsWrapAroundQuery())
  }
  ...
  Query rightBitShiftOperandIsNegativeOrTooWideQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TRightBitShiftOperandIsNegativeOrTooWideQuery())
  }
  ...
  Query floatsTestedForEqualityQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TFloatsTestedForEqualityQuery())
  }
  ...
  Query passPromotablePrimitiveTypeToVaStartQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TPassPromotablePrimitiveTypeToVaStartQuery())
  }
  ...
  Query passReferenceTypeToVaStartQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TPassReferenceTypeToVaStartQuery())
  }
  ...
  Query passNonTrivialObjectToVaStartQuery() {
    ...
    result =
      ...
      TExpressionsPackageQuery(TPassNonTrivialObjectToVaStartQuery())
  }
}
