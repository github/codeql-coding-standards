...
module SideEffects2Package {
  Query moveConstructorShallOnlyMoveObjectQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TMoveConstructorShallOnlyMoveObjectQuery())
  }
  ...
  Query copyConstructorShallOnlyCopyObjectQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TCopyConstructorShallOnlyCopyObjectQuery())
  }
  ...
  Query userDefinedLiteralsOperatorsShallOnlyPerformConversionOfPassedParametersQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TUserDefinedLiteralsOperatorsShallOnlyPerformConversionOfPassedParametersQuery())
  }
  ...
  Query userDefinedLiteralsOperatorsShallNotHaveSideEffectsQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TUserDefinedLiteralsOperatorsShallNotHaveSideEffectsQuery())
  }
  ...
  Query stateRelatedToFunctionObjectIdentityShallNotBeCopiedQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TStateRelatedToFunctionObjectIdentityShallNotBeCopiedQuery())
  }
  ...
  Query moveOperatorShallOnlyMoveObjectQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TMoveOperatorShallOnlyMoveObjectQuery())
  }
  ...
  Query copyOperatorShallOnlyCopyObjectQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TCopyOperatorShallOnlyCopyObjectQuery())
  }
  ...
  Query functionsWithVoidReturnTypeShallHaveExternalSideEffectsQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TFunctionsWithVoidReturnTypeShallHaveExternalSideEffectsQuery())
  }
  ...
  Query predicateFunctionObjectsShouldNotBeMutableQuery() {
    ...
    result =
      ...
      TSideEffects2PackageQuery(TPredicateFunctionObjectsShouldNotBeMutableQuery())
  }
}
