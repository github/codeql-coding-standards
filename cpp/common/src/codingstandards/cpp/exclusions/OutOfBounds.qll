...
module OutOfBoundsPackage {
  Query containerAccessWithoutRangeCheckAutosarQuery() {
    ...
    result =
      ...
      TOutOfBoundsPackageQuery(TContainerAccessWithoutRangeCheckAutosarQuery())
  }
  ...
  Query containerAccessWithoutRangeCheckCertQuery() {
    ...
    result =
      ...
      TOutOfBoundsPackageQuery(TContainerAccessWithoutRangeCheckCertQuery())
  }
  ...
  Query guaranteeGenericCppLibraryFunctionsDoNotOverflowQuery() {
    ...
    result =
      ...
      TOutOfBoundsPackageQuery(TGuaranteeGenericCppLibraryFunctionsDoNotOverflowQuery())
  }
  ...
  Query rangeCheckStringElementAccessQuery() {
    ...
    result =
      ...
      TOutOfBoundsPackageQuery(TRangeCheckStringElementAccessQuery())
  }
}
