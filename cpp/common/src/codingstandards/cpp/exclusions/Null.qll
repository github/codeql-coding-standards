...
module NullPackage {
  Query nullPointersDereferencedQuery() {
    ...
    result =
      ...
      TNullPackageQuery(TNullPointersDereferencedQuery())
  }
  ...
  Query parameterNotPassedByReferenceQuery() {
    ...
    result =
      ...
      TNullPackageQuery(TParameterNotPassedByReferenceQuery())
  }
  ...
  Query doNotAttemptToCreateAStringFromANullPointerQuery() {
    ...
    result =
      ...
      TNullPackageQuery(TDoNotAttemptToCreateAStringFromANullPointerQuery())
  }
}
