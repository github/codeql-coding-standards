...
module UninitializedPackage {
  Query memoryNotInitializedBeforeItIsReadQuery() {
    ...
    result =
      ...
      TUninitializedPackageQuery(TMemoryNotInitializedBeforeItIsReadQuery())
  }
  ...
  Query informationLeakageAcrossTrustBoundariesQuery() {
    ...
    result =
      ...
      TUninitializedPackageQuery(TInformationLeakageAcrossTrustBoundariesQuery())
  }
  ...
  Query doNotReadUninitializedMemoryQuery() {
    ...
    result =
      ...
      TUninitializedPackageQuery(TDoNotReadUninitializedMemoryQuery())
  }
}
