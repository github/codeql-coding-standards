...
module SideEffects1Package {
  Query evaluationOfTheOperandToTheTypeidOperatorContainSideEffectsQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TEvaluationOfTheOperandToTheTypeidOperatorContainSideEffectsQuery())
  }
  ...
  Query rightHandOperandOfALogicalAndOperatorsContainSideEffectsQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TRightHandOperandOfALogicalAndOperatorsContainSideEffectsQuery())
  }
  ...
  Query evaluationOfTheOperandToTheSizeofOperatorContainSideEffectsQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TEvaluationOfTheOperandToTheSizeofOperatorContainSideEffectsQuery())
  }
  ...
  Query doNotDependOnTheOrderOfScalarObjectEvaluationForSideEffectsQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TDoNotDependOnTheOrderOfScalarObjectEvaluationForSideEffectsQuery())
  }
  ...
  Query doNotDependOnTheOrderOfEvaluationForSideEffectsInFunctionCallsAsFunctionArgumentsQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TDoNotDependOnTheOrderOfEvaluationForSideEffectsInFunctionCallsAsFunctionArgumentsQuery())
  }
  ...
  Query doNotRelyOnSideEffectsInSizeOfOperandQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TDoNotRelyOnSideEffectsInSizeOfOperandQuery())
  }
  ...
  Query doNotRelyOnSideEffectsInTypeIdOperandQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TDoNotRelyOnSideEffectsInTypeIdOperandQuery())
  }
  ...
  Query doNotRelyOnSideEffectsInNoExceptOperandQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TDoNotRelyOnSideEffectsInNoExceptOperandQuery())
  }
  ...
  Query doNotRelyOnSideEffectsInDeclTypeOperandQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TDoNotRelyOnSideEffectsInDeclTypeOperandQuery())
  }
  ...
  Query doNotRelyOnSideEffectsInDeclValExpressionQuery() {
    ...
    result =
      ...
      TSideEffects1PackageQuery(TDoNotRelyOnSideEffectsInDeclValExpressionQuery())
  }
}
