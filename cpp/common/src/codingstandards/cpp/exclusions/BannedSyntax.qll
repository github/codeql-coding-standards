...
module BannedSyntaxPackage {
  ...
  Query cStyleArraysUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TCStyleArraysUsedQuery())
  }
  ...
  Query volatileKeywordUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TVolatileKeywordUsedQuery())
  }
  ...
  Query ternaryConditionalOperatorUsedAsSubExpressionQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TTernaryConditionalOperatorUsedAsSubExpressionQuery())
  }
  ...
  Query dynamicCastShouldNotBeUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TDynamicCastShouldNotBeUsedQuery())
  }
  ...
  Query traditionalCStyleCastsUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TTraditionalCStyleCastsUsedQuery())
  }
  ...
  Query reinterpretCastUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TReinterpretCastUsedQuery())
  }
  ...
  Query gotoStatementUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TGotoStatementUsedQuery())
  }
  ...
  Query registerKeywordUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TRegisterKeywordUsedQuery())
  }
  ...
  Query typedefSpecifierUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TTypedefSpecifierUsedQuery())
  }
  ...
  Query asmDeclarationUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TAsmDeclarationUsedQuery())
  }
  ...
  Query functionsDefinedUsingTheEllipsisNotationQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TFunctionsDefinedUsingTheEllipsisNotationQuery())
  }
  ...
  Query unionsUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TUnionsUsedQuery())
  }
  ...
  Query commaOperatorUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TCommaOperatorUsedQuery())
  }
  ...
  Query usingDirectivesUsedQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TUsingDirectivesUsedQuery())
  }
  ...
  Query usingDeclarationsUsedInHeaderFilesQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TUsingDeclarationsUsedInHeaderFilesQuery())
  }
  ...
  Query doNotDefineACStyleVariadicFunctionQuery() {
    ...
    result =
      ...
      TBannedSyntaxPackageQuery(TDoNotDefineACStyleVariadicFunctionQuery())
  }
}
