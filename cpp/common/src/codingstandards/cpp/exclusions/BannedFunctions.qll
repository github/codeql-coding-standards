...
module BannedFunctionsPackage {
  Query functionsMallocCallocReallocAndFreeUsedQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TFunctionsMallocCallocReallocAndFreeUsedQuery())
  }
  ...
  Query bindUsedQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TBindUsedQuery())
  }
  ...
  Query pseudorandomNumbersGeneratedUsingRandQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TPseudorandomNumbersGeneratedUsingRandQuery())
  }
  ...
  Query setjmpMacroAndTheLongjmpFunctionUsedQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TSetjmpMacroAndTheLongjmpFunctionUsedQuery())
  }
  ...
  Query libraryFunctionsAbortExitGetenvAndSystemFromLibraryCstdlibUsedQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TLibraryFunctionsAbortExitGetenvAndSystemFromLibraryCstdlibUsedQuery())
  }
  ...
  Query timeHandlingFunctionsOfLibraryCtimeUsedQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TTimeHandlingFunctionsOfLibraryCtimeUsedQuery())
  }
  ...
  Query unboundedFunctionsOfLibraryCstringUsedQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TUnboundedFunctionsOfLibraryCstringUsedQuery())
  }
  ...
  Query macroOffsetofUsedQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TMacroOffsetofUsedQuery())
  }
  ...
  Query doNotUseSetjmpOrLongjmpQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TDoNotUseSetjmpOrLongjmpQuery())
  }
  ...
  Query doNotUseRandForGeneratingPseudorandomNumbersQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TDoNotUseRandForGeneratingPseudorandomNumbersQuery())
  }
  ...
  Query preferSpecialMemberFunctionsAndOverloadedOperatorsToCStandardLibraryFunctionsQuery() {
    ...
    result =
      ...
      TBannedFunctionsPackageQuery(TPreferSpecialMemberFunctionsAndOverloadedOperatorsToCStandardLibraryFunctionsQuery())
  }
}
