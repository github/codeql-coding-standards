...
module IOPackage {
  Query interleavedInputOutputWithoutFlushQuery() {
    ...
    result =
      ...
      TIOPackageQuery(TInterleavedInputOutputWithoutFlushQuery())
  }
  ...
  Query interleavedInputOutputWithoutPositionQuery() {
    ...
    result =
      ...
      TIOPackageQuery(TInterleavedInputOutputWithoutPositionQuery())
  }
  ...
  Query closeFilesWhenTheyAreNoLongerNeededQuery() {
    ...
    result =
      ...
      TIOPackageQuery(TCloseFilesWhenTheyAreNoLongerNeededQuery())
  }
}
