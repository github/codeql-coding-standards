 ...
 * This is a copy of the out of the box library that is in a query specific library
 * https://github.com/github/codeql/blob/main/cpp/ql/src/Security/CWE/CWE-457/InitializationFunctions.qll
 * at cc7a9ef.
 */
